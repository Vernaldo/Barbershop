                                    ...
                                    <div class="row">
                                            ...
                                            <div class="service-item">
                                                <div class="row">
                                                    <div class="col text-center">
                                                        <img src="image/User_logo.jpg" class="img-fluid rounded-circle col-6" alt="" height="50" width="50" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <h4 class="text-center pt-2">Abdul Waheed</h4>
                                                        ...
                                                        <p class="pt-2">
                                                            Abdul is responsible for marketing and product growth at BarberShop. When not busy at BarberShop, Pawan enjoys
                                        ...
                                        <div class="col-md-4 px-3">
                                            ...
                                            <div class="service-item">
                                                <div class="row">
                                                    <div class="col text-center">
                                                        <img src="image/User_logo.jpg" class="img-fluid rounded-circle col-6" alt="" height="120" width="120" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <h4 class="text-center pt-2">Twalha Maro</h4>
                                                        ...
                                                        <p class="pt-2">
                                                            Twalha leads technology and product development at BarberShop. In his free time, Raghav loves to venture outdoors and try
                                        ...
                                        <div class="col-md-4 px-3">
                                            ...
                                            <div class="service-item">
                                                <div class="row">
                                                    <div class="col text-center">
                                                        <img src="image/User_logo.jpg" class="img-fluid rounded-circle col-6" alt="" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <h4 class="text-center pt-2">Rashid Ali</h4>
                                                        ...
                                                        <p class="pt-2">
                                                            Rashid is responsible for operations and service provider on-boarding at BarberShop. When not building BarberShop,
